...
public class Step3 {
    ...
    static int[] userPredictions = new int[toursNum];
    static int[] userDiceRolls = new int[toursNum];
    static int[] userResults = new int[toursNum];

    static int[] computersPredictions = new int[toursNum];
    static int[] computersDiceRolls = new int[toursNum];
